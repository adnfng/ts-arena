...
const { default: Arena } = require("../dist/cjs/index.js");
const { createMockFetch, toHeaders } = require("./helpers/mock-fetch.cjs");
...
test("v3.users, v3.groups, v3.search, and v3.system route correctly", async () => {
  const { fetch, calls } = createMockFetch([
    ...
    { body: { data: [], meta: { current_page: 1, per_page: 24, total_pages: 1, total_count: 0, next_page: null, prev_page: null, has_more_pages: false } } },
